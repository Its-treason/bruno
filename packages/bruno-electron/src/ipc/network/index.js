...
const registerNetworkIpc = (mainWindow) => {
  ...
  ipcMain.handle(
    'send-http-request',
    async (event, item, collection, environment, runtimeVariables, useNewRequest) => {
      if (useNewRequest) {
  ...
  ipcMain.handle(
    ...
    async (event, folder, collection, environment, runtimeVariables, recursive, newRequestMethod) => {
      if (newRequestMethod) {
